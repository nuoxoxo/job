...
enum e_btn_type		builtin_typeof(t_atom *cmd, t_token *token); // New
void	builtin_atom(t_env *envlist, t_token *node, enum e_btn_type type); // New
void    builtin_atom_xcq(t_env *envlist, t_atom *node, enum e_btn_type type); // New

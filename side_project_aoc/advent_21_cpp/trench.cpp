...
int     main(int argc, char *argv[])
{
         ...
         *
         *  in case where ALGO[0] is a '#', background flashes once every 
         *  two genertions, so in each generation 2 extra layers have to be 
         *  considered.
         *  why two it is because every brick is a center of a 3x3 block, 
         *  2 generations * 2 layers/generation = 4
         *  
         *  */

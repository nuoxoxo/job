...
pair<int, int>	couple(vector<vector<vector<pair<int, int>>>> d, vector<int> c);
vector<vector<vector<pair<int, int>>>>	make_decks(vector<int> nums);
void    print_sample(vector<vector<vector<pair<int, int>>>> decks);
void	check_num(vector<vector<pair<int, int>>>& deck, int call);
...
int	count_score(vector<vector<pair<int, int>>> deck, int call);

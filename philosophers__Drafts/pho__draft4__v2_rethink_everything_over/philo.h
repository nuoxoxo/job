...
{
	pthread_mutex_t		mtx_anyone_can_use; // new in v5 . temp no use
	...
	int					time_to_sleep;
	int					time_to_die;
	int					flag_of_death; // not used in is_dead
	int					meals;
}	t_table;
 ...
 *
 *	sep 12 update:
 *	struct done editing . added 1 mutex :: mtx_anyone_can_use
 *
 *	all following func are subject to change
 *
 *
 *
 */
